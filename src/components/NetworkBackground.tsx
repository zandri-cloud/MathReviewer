...
export function NetworkBackground() {
  ...
  useEffect(() => {
    ...
    let particleCount = 67; // 67 math nodes/particles!
    ...
    const resize = () => {
      ...
      // Adjust particle count for mobile/tablets to prevent lag
      ...
      // Re-initialize particles if needed, but doing it correctly
      // We can just trim the array if it's too long, or add more
