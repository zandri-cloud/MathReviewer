      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        >
          ...
          <div className="py-8 border-y border-surface-container-high text-on-surface flex flex-col items-center gap-6">
            <MathText block math={String.raw`\frac{d}{dx}(\ln x) = \lim_{h \to 0} \frac{\ln(x+h) - \ln x}{h}`} />
            <MathText block math={String.raw`= \lim_{h \to 0} \frac{1}{h} \ln\left(1 + \frac{h}{x}\right) = \frac{1}{x}`} />
          </div>
